...
<ul>
<li>**1. Dataset en dos archivos csv:** csv con datos de las gasolineras y csv actualizable con histórico de precios diarios de las diferentes gasolineras.<p>
<li>**3. Dataset completo en un archivo csv** (combinación de los dos primeros datasets)**<p>
</ul>
...
El conjunto de datos ha sido extraido de la página web de bonÁrea y contiene datos sobre los distintos establecimientos de la marca (gasolinera, tienda, supermercado, box, bufet, depósito, cash). Para cada uno de los establecimientos se dispone de una url información geográfica y servicios disponibles en el mismo. En el caso concreto de las gasolineras disponemos además de los precios de distintos tipos de combustible.  
