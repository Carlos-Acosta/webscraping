...
(PONER FOTO DE LA PAGINA WEB - > CARLOS)<p>
...
CHECK HERE: El dataset XXXXXXXX XXXXXXx XXXXXXxxx contiene los precios diarios de los carburantes en distintas gasolineras de la red BonÀrea en el período de tiempo desde el 23 de marzo de 2021 hasta la fecha de entrega de la práctica.

El dataset consta de 2 ficheros csv: 
* precios_carburantes_bonarea contiene datos sobre los precios diarios de los carburantes en todas las gasolineras de la red. Los campos son:
...
* bonarea_gasolineras contiene la información de las gasolineras:  
  - id - número identificador de la gasolinera	
  ...
  - minutsLatitude - latitud en minutos	  
  - minutsLongitude	- longitud en minutos  
  - RENTADOR	- tiene túnel de lavado de coches, booleano   
  - CANVI	-  tienen cambio para dinero, booleano  
  - SUPER	- tiene supermercado, booleano  
  - LAVABO - tiene lavabo, booleano	 
  - PARKING - tiene parking, booleano	 
  - VENDING - tiene máquinas de vending, booleano  
